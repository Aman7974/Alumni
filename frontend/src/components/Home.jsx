                ...
                <div className="container h-100">
                    <div className="row h-100 align-items-center justify-content-center">
                        <div className="col-lg-8  text-center">
                            <h1 className="text-white font-weight-bold display-3 mb-4">Welcome to ALUMNI</h1>
                            <p className="text-white-75 font-weight-light lead mb-5">Connecting Alumni Across The Globe</p>
            ...
            <section className={`page-section bg-${theme}`} id="alumni-benefits">
                <div className="container">
                    <div className="text-center">
                        ...
                        <h3 className=" card-title text-muted">As a member of the alumni network, you have access to a variety of exclusive services and benefits.</h3>
                    </div>
                    <div className="row">
